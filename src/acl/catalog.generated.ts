// AUTO-GENERATED by src/acl/generate.ts — do not edit by hand.
...
export const WAZO_ACL_CATALOG: AclCatalog = {
  "apiVersion": "26.07",
  "services": [
    {
      "key": "nestbox-confd",
      "label": "Reseller configuration",
      "acls": [
        "confd.accounts.read",
        "confd.accounts.summary.read",
        "confd.config.read",
        "confd.customers.create",
        "confd.customers.read",
        "confd.customers.{customer_uuid}.delete",
        "confd.customers.{customer_uuid}.read",
        "confd.customers.{customer_uuid}.update",
        "confd.engines.instances.{instance_uuid}.accounts.events.create",
        "confd.engines.instances.{instance_uuid}.accounts.synchronize.create",
        "confd.engines.instances.{instance_uuid}.accounts.synchronize.read",
        "confd.instances.read",
        "confd.locations.create",
        "confd.locations.read",
        "confd.locations.{location_uuid}.delete",
        "confd.locations.{location_uuid}.read",
        "confd.locations.{location_uuid}.update",
        "confd.locations.{location_uuid}.wazo.tenants.update",
        "confd.plugins.create",
        "confd.plugins.read",
        "confd.plugins.{plugin_uuid}.delete",
        "confd.plugins.{plugin_uuid}.installs.customers.create",
        "confd.plugins.{plugin_uuid}.installs.customers.read",
        "confd.plugins.{plugin_uuid}.installs.locations.create",
        "confd.plugins.{plugin_uuid}.installs.locations.read",
        "confd.plugins.{plugin_uuid}.installs.resellers.create",
        "confd.plugins.{plugin_uuid}.installs.resellers.read",
        "confd.plugins.{plugin_uuid}.read",
        "confd.plugins.{plugin_uuid}.update",
        "confd.resellers.create",
        "confd.resellers.read",
        "confd.resellers.{reseller_uuid}.delete",
    ...
    },
    {
      ...
      "acls": [
        "accessd.authorizations.create",
        "accessd.authorizations.read",
        "accessd.authorizations.seats.read",
        "accessd.authorizations.token.create",
        "accessd.authorizations.{authorization_uuid}.delete",
        "accessd.authorizations.{authorization_uuid}.read",
        "accessd.authorizations.{authorization_uuid}.update",
        "accessd.config.read",
        "accessd.customers.subscriptions.default.summary.read",
        "accessd.customers.{customer_uuid}.subscriptions.default.activate.update",
        "accessd.customers.{customer_uuid}.subscriptions.default.expire.update",
        "accessd.customers.{customer_uuid}.subscriptions.default.read",
        "accessd.customers.{customer_uuid}.subscriptions.default.update",
        "accessd.subscriptions.default.activate.update",
        "accessd.subscriptions.default.expire.update",
        "accessd.subscriptions.default.read",
        "accessd.subscriptions.default.summary.read",
        "accessd.subscriptions.default.update",
        "accessd.subscriptions.read",
        "accessd.subscriptions.token.create",
        "accessd.subscriptions.{subscription_uuid}.authorizations.create",
        "accessd.subscriptions.{subscription_uuid}.authorizations.{authorization_uuid}.delete",
        "accessd.subscriptions.{subscription_uuid}.authorizations.{authorization_uuid}.update",
        "accessd.subscriptions.{subscription_uuid}.delete",
        "accessd.subscriptions.{subscription_uuid}.read",
        "accessd.subscriptions.{subscription_uuid}.update"
      ]
    },
    {
      "key": "wazo-agentd",
      "label": "Agents",
      "acls": [
        "agentd.agents.by-id.{agent_id}.add.create",
        "agentd.agents.by-id.{agent_id}.login.create",
        "agentd.agents.by-id.{agent_id}.logoff.create",
        "agentd.agents.by-id.{agent_id}.read",
        "agentd.agents.by-id.{agent_id}.remove.create",
        "agentd.agents.by-number.{agent_number}.login.create",
        "agentd.agents.by-number.{agent_number}.logoff.create",
        "agentd.agents.by-number.{agent_number}.pause.create",
        "agentd.agents.by-number.{agent_number}.read",
        "agentd.agents.by-number.{agent_number}.unpause.create",
        "agentd.agents.logoff.create",
        "agentd.agents.read",
        "agentd.agents.relog.create",
        "agentd.agents.{agent_id}.queues.{queue_id}.login.update",
        "agentd.agents.{agent_id}.queues.{queue_id}.logoff.update",
        "agentd.status.read",
        "agentd.users.me.agents.login.create",
        "agentd.users.me.agents.logoff.create",
        "agentd.users.me.agents.pause.create",
        "agentd.users.me.agents.queues.{queue_id}.login.update",
        "agentd.users.me.agents.queues.{queue_id}.logoff.update",
        "agentd.users.me.agents.read",
        "agentd.users.me.agents.unpause.create"
      ]
    },
    {
      "key": "wazo-amid",
    ...
    },
    {
      ...
      "acls": [
        "auth.admin.users.{user_uuid}.emails.update",
        ...
        "auth.groups.{group_uuid}.policies.read",
        "auth.groups.{group_uuid}.policies.{policy_uuid}.create",
        "auth.groups.{group_uuid}.policies.{policy_uuid}.delete",
        "auth.groups.{group_uuid}.update",
        "auth.groups.{group_uuid}.users.read",
        "auth.groups.{group_uuid}.users.{user_uuid}.create",
        "auth.groups.{group_uuid}.users.{user_uuid}.delete",
        ...
        "auth.policies.{policy_uuid}.update",
        "auth.sessions.read",
        ...
        "auth.tenants.{tenant_uuid}.parent.{parent_tenant_uuid}.update",
        "auth.tenants.{tenant_uuid}.read",
        "auth.tenants.{tenant_uuid}.update",
        "auth.tokens.read",
        "auth.users.create",
        "auth.users.password.reset.{user_uuid}.create",
        "auth.users.read",
        "auth.users.{user_uuid}.delete",
        "auth.users.{user_uuid}.emails.update",
        "auth.users.{user_uuid}.emails.{email_uuid}.confirm.read",
        "auth.users.{user_uuid}.external.google.create",
        "auth.users.{user_uuid}.external.google.delete",
        "auth.users.{user_uuid}.external.google.read",
        "auth.users.{user_uuid}.external.microsoft.create",
        "auth.users.{user_uuid}.external.microsoft.delete",
        "auth.users.{user_uuid}.external.microsoft.read",
        "auth.users.{user_uuid}.external.mobile.create",
        "auth.users.{user_uuid}.external.mobile.delete",
        "auth.users.{user_uuid}.external.mobile.read",
        "auth.users.{user_uuid}.external.mobile.sender_id.read",
        "auth.users.{user_uuid}.external.mobile.update",
        "auth.users.{user_uuid}.external.read",
        "auth.users.{user_uuid}.groups.read",
        "auth.users.{user_uuid}.password.update",
        "auth.users.{user_uuid}.policies.read",
        "auth.users.{user_uuid}.policies.{policy_uuid}.create",
        "auth.users.{user_uuid}.policies.{policy_uuid}.delete",
        "auth.users.{user_uuid}.read",
        "auth.users.{user_uuid}.sessions.read",
        "auth.users.{user_uuid}.sessions.{session_uuid}.delete",
        "auth.users.{user_uuid}.tokens.read",
        "auth.users.{user_uuid}.tokens.{client_id}.delete",
        "auth.users.{user_uuid}.update",
        "auth.{auth_type}.external.config.create",
        "auth.{auth_type}.external.config.delete",
        "auth.{auth_type}.external.config.read",
        "auth.{auth_type}.external.config.update",
    ...
    },
    {
      ...
      "acls": [
        ...
        "call_logd.config.read",
        "call_logd.config.update"
      ]
    },
    {
      "key": "wazo-calld",
      "label": "Calls",
      "acls": [
        "calld.applications.{application_uuid}.calls.create",
        "calld.applications.{application_uuid}.calls.read",
        "calld.applications.{application_uuid}.calls.{call_id}.answer.update",
        "calld.applications.{application_uuid}.calls.{call_id}.delete",
        ...
        "calld.applications.{application_uuid}.calls.{call_id}.snoops.create",
        "calld.applications.{application_uuid}.nodes.create",
        "calld.applications.{application_uuid}.nodes.read",
        ...
        "calld.applications.{application_uuid}.nodes.{node_uuid}.delete",
        "calld.applications.{application_uuid}.nodes.{node_uuid}.read",
        "calld.applications.{application_uuid}.playbacks.{playback_uuid}.delete",
        "calld.applications.{application_uuid}.read",
        "calld.applications.{application_uuid}.snoops.read",
        "calld.applications.{application_uuid}.snoops.{snoop_uuid}.delete",
        "calld.applications.{application_uuid}.snoops.{snoop_uuid}.read",
        "calld.applications.{application_uuid}.snoops.{snoop_uuid}.update",
        "calld.calls.create",
        "calld.calls.read",
        ...
        "calld.calls.{call_id}.record.pause.update",
        "calld.calls.{call_id}.record.resume.update",
        "calld.calls.{call_id}.record.start.update",
        "calld.calls.{call_id}.record.stop.update",
        "calld.calls.{call_id}.user.{user_uuid}.update",
        "calld.conferences.{conference_id}.participants.read",
        ...
        "calld.conferences.{conference_id}.record.create",
        "calld.conferences.{conference_id}.record.delete",
        "calld.config.read",
        "calld.config.update",
        "calld.faxes.create",
        "calld.lines.read",
        "calld.meetings.{meeting_uuid}.participants.delete",
        "calld.meetings.{meeting_uuid}.participants.read",
        "calld.parkings.read",
        "calld.parkings.{parking_id}.read",
        "calld.relocates.users.me.{relocate_uuid}.read",
        "calld.status.read",
        "calld.switchboards.{switchboard_uuid}.calls.held.read",
        "calld.switchboards.{switchboard_uuid}.calls.held.{call_id}.answer.update",
        "calld.switchboards.{switchboard_uuid}.calls.held.{call_id}.update",
        "calld.switchboards.{switchboard_uuid}.calls.queued.read",
        "calld.switchboards.{switchboard_uuid}.calls.queued.{call_id}.answer.update",
        "calld.transfers.create",
        "calld.transfers.{transfer_id}.complete.update",
        "calld.transfers.{transfer_id}.delete",
        "calld.transfers.{transfer_id}.read",
        "calld.trunks.read",
        "calld.users.me.calls.create",
        "calld.users.me.calls.read",
        "calld.users.me.calls.{call_id}.answer.update",
        "calld.users.me.calls.{call_id}.delete",
        "calld.users.me.calls.{call_id}.hold.start.update",
        "calld.users.me.calls.{call_id}.hold.stop.update",
        "calld.users.me.calls.{call_id}.mute.start.update",
        "calld.users.me.calls.{call_id}.mute.stop.update",
        "calld.users.me.calls.{call_id}.park.update",
        "calld.users.me.conferences.adhoc.create",
        "calld.users.me.conferences.adhoc.delete",
        "calld.users.me.conferences.adhoc.participants.delete",
        "calld.users.me.conferences.adhoc.participants.update",
        "calld.users.me.conferences.{conference_id}.participants.read",
        "calld.users.me.faxes.create",
        "calld.users.me.meetings.participants.delete",
        "calld.users.me.meetings.{meeting_uuid}.participants.read",
        "calld.users.me.relocates.create",
        "calld.users.me.relocates.read",
        "calld.users.me.relocates.{relocate_uuid}.cancel.update",
        "calld.users.me.relocates.{relocate_uuid}.complete.update",
        "calld.users.me.transfers.create",
        "calld.users.me.transfers.read",
        "calld.users.me.transfers.{transfer_id}.complete.update",
        "calld.users.me.transfers.{transfer_id}.delete",
        "calld.users.me.voicemails.folders.{folder_id}.read",
        "calld.users.me.voicemails.greetings.{greeting}.copy.create",
        "calld.users.me.voicemails.greetings.{greeting}.create",
        "calld.users.me.voicemails.greetings.{greeting}.delete",
        "calld.users.me.voicemails.greetings.{greeting}.read",
        "calld.users.me.voicemails.greetings.{greeting}.update",
        "calld.users.me.voicemails.messages.read",
        "calld.users.me.voicemails.messages.{message_id}.delete",
        "calld.users.me.voicemails.messages.{message_id}.read",
        "calld.users.me.voicemails.messages.{message_id}.recording.read",
        "calld.users.me.voicemails.messages.{message_id}.update",
        "calld.users.me.voicemails.read",
        "calld.voicemails.messages.read",
        "calld.voicemails.{voicemail_id}.folders.{folder_id}.read",
        "calld.voicemails.{voicemail_id}.greetings.{greeting}.copy.create",
        "calld.voicemails.{voicemail_id}.greetings.{greeting}.create",
        "calld.voicemails.{voicemail_id}.greetings.{greeting}.delete",
        "calld.voicemails.{voicemail_id}.greetings.{greeting}.read",
        "calld.voicemails.{voicemail_id}.greetings.{greeting}.update",
        "calld.voicemails.{voicemail_id}.messages.{message_id}.delete",
        "calld.voicemails.{voicemail_id}.messages.{message_id}.read",
        "calld.voicemails.{voicemail_id}.messages.{message_id}.recording.read",
        "calld.voicemails.{voicemail_id}.messages.{message_id}.update",
        "calld.voicemails.{voicemail_id}.read"
      ]
    },
    {
      "key": "wazo-chatd",
      ...
      "acls": [
        "chatd.config.read",
        "chatd.config.update",
        "chatd.connectors.read",
        "chatd.connectors.{backend}.auth-schema.read",
        "chatd.connectors.{backend}.identities.read",
        "chatd.identities.create",
        "chatd.identities.read",
        "chatd.identities.{identity_uuid}.delete",
        "chatd.identities.{identity_uuid}.read",
        "chatd.identities.{identity_uuid}.update",
        "chatd.status.read",
        "chatd.users.me.identities.read",
        "chatd.users.me.rooms.create",
        "chatd.users.me.rooms.messages.read",
        "chatd.users.me.rooms.read",
        "chatd.users.me.rooms.{room_uuid}.messages.create",
        "chatd.users.me.rooms.{room_uuid}.messages.read",
        "chatd.users.presences.read",
        "chatd.users.{user_uuid}.presences.read",
        "chatd.users.{user_uuid}.presences.update"
      ]
    },
    {
      "key": "wazo-confd",
      ...
      "acls": [
        ...
        "confd.recordings.announcements.read",
        "confd.recordings.announcements.update",
        ...
        "confd.sip.transports.create",
        "confd.sip.transports.read",
        "confd.sip.transports.{transport_uuid}.delete",
        "confd.sip.transports.{transport_uuid}.read",
        "confd.sip.transports.{transport_uuid}.update",
        "confd.sounds.create",
        ...
        "confd.users.import.update",
        "confd.users.me.blocklist.create",
        "confd.users.me.blocklist.delete",
        "confd.users.me.blocklist.read",
        "confd.users.me.blocklist.update",
        "confd.users.me.meetings.create",
        "confd.users.me.meetings.read",
        "confd.users.me.meetings.{meeting_uuid}.delete",
        "confd.users.me.meetings.{meeting_uuid}.read",
        "confd.users.me.meetings.{meeting_uuid}.update",
        "confd.users.read",
        ...
        "confd.users.{user_id}.forwards.{forward_name}.read",
        ...
        "confd.users.{user_uuid}.blocklist.read",
    ...
    },
    {
      ...
      "acls": [
        "deployd.config.read",
        "deployd.instances.create",
        "deployd.instances.read",
        "deployd.instances.{instance_uuid}.credentials.create",
        "deployd.instances.{instance_uuid}.credentials.{credential_uuid}.delete",
        "deployd.instances.{instance_uuid}.credentials.{credential_uuid}.get",
        "deployd.instances.{instance_uuid}.credentials.{credential_uuid}.update",
        "deployd.instances.{instance_uuid}.delete",
        "deployd.instances.{instance_uuid}.read",
        "deployd.instances.{instance_uuid}.update",
        "deployd.instances.{instance_uuid}.wazo.read",
        "deployd.providers.create",
        "deployd.providers.platforms.read",
        "deployd.providers.read",
        "deployd.providers.{provider_uuid}.delete",
        "deployd.providers.{provider_uuid}.images.read",
        "deployd.providers.{provider_uuid}.instances.read",
        "deployd.providers.{provider_uuid}.instances.{instance_uuid}.delete",
        "deployd.providers.{provider_uuid}.keypairs.read",
        "deployd.providers.{provider_uuid}.locations.read",
        "deployd.providers.{provider_uuid}.networks.read",
        "deployd.providers.{provider_uuid}.read",
        "deployd.providers.{provider_uuid}.regions.read",
        "deployd.providers.{provider_uuid}.sizes.read",
        "deployd.providers.{provider_uuid}.subnets.read",
        "deployd.providers.{provider_uuid}.update"
      ]
    },
    {
      "key": "wazo-dird",
      ...
      "acls": [
        ...
        "dird.displays.{display_uuid}.read",
        "dird.displays.{display_uuid}.update",
        "dird.graphql.{root_field_name}",
        ...
        "dird.phonebooks.{phonebook_uuid}.update",
        "dird.profiles.create",
        "dird.profiles.read",
        "dird.profiles.{profile_uuid}.delete",
        "dird.profiles.{profile_uuid}.read",
        "dird.profiles.{profile_uuid}.update",
        "dird.services.read",
        "dird.sources.read",
        "dird.status.read",
        "dird.tenants.{tenant}.phonebooks.create",
        "dird.tenants.{tenant}.phonebooks.read",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.contacts.create",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.contacts.read",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.contacts.{contact_id}.delete",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.contacts.{contact_id}.read",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.contacts.{contact_id}.update",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.delete",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.read",
        "dird.tenants.{tenant}.phonebooks.{phonebook_id}.update"
      ]
    },
    {
      "key": "wazo-plugind",
    ...
    },
    {
      ...
      "label": "Provisioning",
      "acls": [
        "provd.cfg_mgr.autocreate.create",
        "provd.cfg_mgr.configs.create",
        "provd.cfg_mgr.configs.read",
        "provd.cfg_mgr.configs.{config_id}.delete",
        "provd.cfg_mgr.configs.{config_id}.raw.read",
        "provd.cfg_mgr.configs.{config_id}.read",
        "provd.cfg_mgr.configs.{config_id}.update",
        "provd.cfg_mgr.read",
    ...
    },
    {
      ...
      "label": "Webhooks",
      "acls": [
        "webhookd.config.read",
        "webhookd.config.update",
        "webhookd.mobile.notifications.send",
        "webhookd.status.read",
        ...
        "webhookd.users.me.subscriptions.create",
        "webhookd.users.me.subscriptions.read",
        "webhookd.users.me.subscriptions.{subscription_uuid}.delete",
        "webhookd.users.me.subscriptions.{subscription_uuid}.read",
        "webhookd.users.me.subscriptions.{subscription_uuid}.update"
      ]
    }
  ],
  "allAcls": [
